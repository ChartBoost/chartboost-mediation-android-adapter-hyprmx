...
android {
    ...
    defaultConfig {
        ...
        android.defaultConfig.versionName = System.getenv("VERSION_OVERRIDE") ?: "5.6.4.7.0"
...
dependencies {
    ...
    // For external usage, please use the following production dependency.
    // You may choose a different release version.
    implementation("com.hyprmx.android:HyprMX-SDK:6.4.7")
...
artifactory {
    ...
    publish {
        ...
        defaults {
            publications("HyprMXAdapter", "aar")
    ...
    publishing {
        publications {
            register<MavenPublication>("remoteRelease") {
                ...
                pom {
                    name.set("Chartboost Mediation Adapter HyprMX")
